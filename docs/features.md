...
The clock view shows the local time in giant digits, updated continuously (CLK-001, CLK-002), with optional seconds (CLK-003) and the same theme as the stopwatch (CLK-004). The time format is:
